        ...
        "A": [
            ...
            },
            {
                ...
                "options": [
                    ...
                    "Una mejora automatica del sistema",
                    "Un problema exclusivo de la impresora",
                ],
                "correct_option": "A",
            },
            {
                ...
                "options": [
                    ...
                    "Renombrarla para que no parezca peligrosa",
        ...
        "B": [
            {
                ...
                "topic": "phishing",
                "construct": "senales_phishing",
                "prompt": "Llega un mensaje que promete liberar una factura si entras hoy a un enlace no solicitado. ¿Qué señal debe hacerte detener?",
                "options": [
                    "La presion de urgencia y el enlace inesperado",
                    "Que el mensaje tenga pocas palabras",
            ...
            },
            {
                ...
                "topic": "phishing",
                "construct": "reporte_accion_segura",
                "prompt": "Detectas un correo que intenta llevar al equipo a un portal falso. ¿Cuál es la mejor accion?",
                "options": [
                    "Reportarlo al canal interno indicado",
                    "Probar el portal con una clave antigua",
                    "Responder al remitente que parece falso",
                    "Reenviarlo sin advertencia para pedir opiniones",
                ],
                "correct_option": "A",
            },
            {
            ...
            },
            {
                ...
                "topic": "passwords",
                "construct": "mfa_verificacion",
                "prompt": "Recibes una alerta de inicio de sesion desde una ubicacion que no reconoces. ¿Qué respuesta es mas segura?",
                "options": [
                    "Confirmar por el canal oficial y cambiar credenciales si aplica",
                    "Aprobarla para no interrumpir el trabajo",
                    "Ignorarla porque MFA siempre protege todo",
            ...
            },
            {
                ...
                "topic": "malware",
                "construct": "usb_archivo_desconocido",
                "prompt": "Recibes un adjunto inesperado de un contacto real, pero no esperabas ningun archivo. ¿Qué haces primero?",
                "options": [
                    "Abrirlo porque el contacto existe",
                    "Verificar el origen por otro canal antes de abrir",
                    "Reenviarlo a todos para preguntar",
                    "Cambiarle el nombre y ejecutarlo",
                ],
                "correct_option": "B",
            },
            {
                ...
                "options": [
                    ...
                    "Siempre es una actualizacion legitima",
            ...
            },
            {
                ...
                "topic": "wifi",
                "construct": "trafico_exfiltracion",
                "prompt": "Se detecta una conexion no reconocida que transfiere documentos internos fuera de la empresa. ¿Qué decision reduce el riesgo?",
                "options": [
                    "Permitirla mientras no falle la red",
                    "Bloquear o aislar segun procedimiento y reportar",
                    "Compartir mas archivos para confirmar",
                    "Cambiar el nombre del equipo solamente",
                ],
                "correct_option": "B",
            },
        ],
